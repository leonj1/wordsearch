 ...
 */
public class GetWordDiagonalTopLeftBottomRight implements Strategy {
    char[][] board;
    int squareSize;
    int colPos;
    int rowPos;
    ...
    public GetWordDiagonalTopLeftBottomRight(char[][] board, int colPos, int rowPos, int numberOfLetters){
        this.board = board;
        this.colPos = colPos;
        this.rowPos = rowPos;
